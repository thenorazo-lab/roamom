...
const HomePage = () => (
  <div className="container">
    ...
    <div className="nav-buttons">
      ...
      <Link to="/points-admin" className="nav-button" style={{fontSize: '0.6rem', padding: '8px 12px', maxWidth: '180px', alignSelf: 'center'}}>?? 포인트 관리자</Link>
    </div>
      ...
      {data && (
        <div>
          ...
          <div className="info-cards">
            <div className="card">
              <h3>?? 날씨 {data.weatherError && <span style={{color:'#a33', fontSize:12, marginLeft:8}}>(데이터 일부 없음)</span>}</h3>
  ...
  return (
    <div className="container">
      ...
      <p style={{ marginBottom: '20px', fontSize: '14px', color: '#666' }}>
        ??? 지도를 클릭해 핀을 꽂고 그 위치의 바다 날씨 정보를 확인하세요!
      </p>
      ...
      {info && (
        <div style={{ marginTop: '30px' }}>
          ...
          <div className="info-cards">
            <div className="card">
              <h3>?? 날씨 {info.weatherError && <span style={{color:'#a33', fontSize:12, marginLeft:8}}>(데이터 일부 없음)</span>}</h3>
